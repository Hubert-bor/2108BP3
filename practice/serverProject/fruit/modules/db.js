...
// updateOne
// ----------------------------------------------------------------
module.exports.updateOne = function (cName, whereObj, res, cb1) {
    connectMGDB(function (dbase, db) {
        whereObj.updateObj ? whereObj.updateObj : whereObj.updateObj = {};
        dbase.collection(cName).updateOne(whereObj.updateObj.old, whereObj.updateObj.new).then(function (err, result) {
            cb1(err, result, db);
        })
    }, res);
}
